...
layout =[     [sg.Text('Select the type of voice:',text_color='white',background_color='black'),sg.Radio('Male', 'RADIO1', default=True, key='male',background_color='black'),sg.Radio('Female', 'RADIO1', key='female',background_color='black')],
...
window = sg.Window('KENNEDY_PROJECT2', layout,background_color='black')
